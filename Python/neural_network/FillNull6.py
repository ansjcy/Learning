...
import numpy as np
#read csv data:
reader = csv.reader(file('/Users/jason/Desktop/modeling/data/fillNull5.csv', 'rb'))
...
ds1 = SupervisedDataSet(9, 6)
ds2 = SupervisedDataSet(9, 6)
ds3 = SupervisedDataSet(9, 6)
ds4 = SupervisedDataSet(9, 6)
ds5 = SupervisedDataSet(9, 6)

magic1 = [9,12,14,16,17,18]
magic2 = [9,16,17,18,19,20]
magic3 = [8,9,17,18,19,20]
magic4 = [9,13,14,15,19,20]
magic5 = [9,14,17,18,19,20]
...
for tuple in data_training_raw:
    ...
    output_tmp1 = []
    for i in range(6, 21):
        if i == magic1[0] or i == magic1[1] or i == magic1[2] or i == magic1[3] or i == magic1[4] or i == magic1[5]:
...
for tuple in data_training_raw:
    ...
    tuple_data = []
    for i in range(6, 21):
        if i == magic2[0] or i == magic2[1] or i == magic2[2] or i == magic2[3] or i == magic2[4] or i == magic2[5]:
                      #here
...
for tuple in data_training_raw:
    ...
    output_tmp3 = []
    for i in range(6, 21):
        if i == magic3[0] or i == magic3[1] or i == magic3[2] or i == magic3[3] or i == magic3[4] or i == magic3[5]:
                      #here
...
for tuple in data_training_raw:
    ...
    output_tmp4 = []
    for i in range(6, 21):
        if i == magic4[0] or i == magic4[1] or i == magic4[2] or i == magic4[3] or i == magic4[4] or i == magic4[5]:
                      #here
...
for tuple in data_training_raw:
    ...
    output_tmp5 = []
    for i in range(6, 21):
        if i == magic5[0] or i == magic5[1] or i == magic5[2] or i == magic5[3] or i == magic5[4] or i == magic5[5]:
                      #here
...
for line in data_fit:
    ...
    if nullNum == 6:
        if nullAttr[0] == magic1[0] and nullAttr[1] == magic1[1] and nullAttr[2] == magic1[2] and nullAttr[3] == magic1[3] and nullAttr[4] == magic1[4] and nullAttr[5] == magic1[5]:
            for i in range(6,21):
                if i == magic1[0] or i == magic1[1] or i == magic1[2] or i == magic1[3] or i == magic1[4] or i == magic1[5]:
                    continue
                else:
        ...
        if nullAttr[0] == magic2[0] and nullAttr[1] == magic2[1] and nullAttr[2] == magic2[2] and nullAttr[3] == magic2[3] and nullAttr[4] == magic2[4] and nullAttr[5] == magic2[5]:
            for i in range(6,21):
                if i == magic2[0] or i == magic2[1] or i == magic2[2] or i == magic2[3] or i == magic2[4] or i == magic2[5]:
                    continue
                else:
        ...
        if nullAttr[0] == magic3[0] and nullAttr[1] == magic3[1] and nullAttr[2] == magic3[2] and nullAttr[3] == magic3[3] and nullAttr[4] == magic3[4] and nullAttr[5] == magic3[5]:
            for i in range(6,21):
                if i == magic3[0] or i == magic3[1] or i == magic3[2] or i == magic3[3] or i == magic3[4] or i == magic3[5]:
                    continue
                else:
        ...
        if nullAttr[0] == magic4[0] and nullAttr[1] == magic4[1] and nullAttr[2] == magic4[2] and nullAttr[3] == magic4[3] and nullAttr[4] == magic4[4] and nullAttr[5] == magic4[5]:
            for i in range(6,21):
                if i == magic4[0] or i == magic4[1] or i == magic4[2] or i == magic4[3] or i == magic4[4] or i == magic4[5]:
                    continue
                else:
        ...
        if nullAttr[0] == magic5[0] and nullAttr[1] == magic5[1] and nullAttr[2] == magic5[2] and nullAttr[3] == magic5[3] and nullAttr[4] == magic5[4] and nullAttr[5] == magic5[5]:
            for i in range(6,21):
                if i == magic5[0] or i == magic5[1] or i == magic5[2] or i == magic5[3] or i == magic5[4] or i == magic5[5]:
                    continue
                else:
            ...
            data_fit[iterOut][magic5[5]] = float(output_5_example[5])



writer = csv.writer(file('/Users/jason/Desktop/modeling/data/fillNull6.csv', 'wb'))
